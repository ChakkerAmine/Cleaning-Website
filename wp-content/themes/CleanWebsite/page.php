                ...
                <div class="col-md-6 text-center text-md-right">
                    ...
                    <?php 
                        ...
                        if($parent_page){
                            ...
                            ?>
                            <div class="d-inline-flex align-items-center">
                                <a class="btn btn-sm btn-outline-light" href="<?php site_url('/') ?>"><?php echo "Home" ?></a>
                                <i class="fas fa-angle-double-right text-light mx-2"></i>
                                <a class="btn btn-sm btn-outline-light disabled" href="#"><?php the_title(); ?></a>
                            </div>
                            <?php 
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12 pt-12 pb-lg-12">
                    ...
                    <h1 class="mb-4 section-title"><?php if(is_page('about')){echo "We Provide The Best Cleaning Services";}else{echo the_title();} ?></h1>
                    <p><?php the_content(); ?></p>
